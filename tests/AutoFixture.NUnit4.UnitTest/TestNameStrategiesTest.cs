...
public class TestNameStrategiesTest
{
    ...
    public void AutoDataFixedNameUsesFixedValuesForTestFullName()
    {
        ...
        Assert.That(testMethod.FullName,
            Is.EqualTo(@"AutoFixture.NUnit4.UnitTest.TestNameStrategiesFixture.FixedNameDecoratedMethod(auto<Int32>,auto<MyClass>)"));
    }
    ...
    public void AutoDataVolatileNameUsesRealValuesForTestFullName()
    {
        ...
        // Assert
        Assert.That(testMethod.FullName,
            Is.EqualTo(@"AutoFixture.NUnit4.UnitTest.TestNameStrategiesFixture.VolatileNameDecoratedMethod(42,""foo"")"));
    }
    ...
    public void InlineAutoDataFixedNameUsesFixedValuesForTestFullName()
    {
        ...
        // Assert
        Assert.That(testMethod.FullName,
            Is.EqualTo(@"AutoFixture.NUnit4.UnitTest.TestNameStrategiesFixture.InlineFixedNameDecoratedMethod(""alpha"",""beta"",auto<String>)"));
    }
    ...
    public void InlineAutoDataVolatileNameUsesRealValuesForFullName()
    {
        ...
        // Assert
        Assert.That(testMethod.FullName,
            Is.EqualTo(@"AutoFixture.NUnit4.UnitTest.TestNameStrategiesFixture.InlineVolatileNameDecoratedMethod(""alpha"",""beta"",""foo"")"));
    }

...
public class Scenario
{
    ...
    {
        ClassicAssert.AreNotEqual(0, primitiveValue);
    }
    ...
    {
        ClassicAssert.NotNull(ph);
        ClassicAssert.NotNull(ph.Property);
    }
    ...
    public void AutoTestCaseProvidesMultipleObjects(PropertyHolder<Version> ph, SingleParameterType<ConcreteType> spt)
    {
        ...
        ClassicAssert.NotNull(spt);
        ClassicAssert.NotNull(spt.Parameter);
    }

    [Test, AutoData]
    public void FreezeFirstParameter([Frozen]Guid g1, Guid g2)
    {
        ClassicAssert.AreEqual(g1, g2);
    }

    [Test, AutoData]
    public void FreezeSecondParameterOnlyFreezesSubsequentParameters(Guid g1, [Frozen]Guid g2, Guid g3)
    {
        ClassicAssert.AreNotEqual(g1, g2);
        ClassicAssert.AreNotEqual(g1, g3);

        ClassicAssert.AreEqual(g2, g3);
    }
        ...
        int expectedNumber, MyClass sut)
    {
        ...
        // Assert
        ClassicAssert.AreEqual(expectedNumber, result);
    }

    [Test, AutoData]
    public void ModestCreatesParameterWithModestConstructor([Modest]MultiUnorderedConstructorType p)
    {
        ClassicAssert.True(string.IsNullOrEmpty(p.Text));
        ClassicAssert.AreEqual(0, p.Number);
    }

    [Test, AutoData]
    public void GreedyCreatesParameterWithGreedyConstructor([Greedy]MultiUnorderedConstructorType p)
    {
        ClassicAssert.False(string.IsNullOrEmpty(p.Text));
        ClassicAssert.AreNotEqual(0, p.Number);
    }
    ...
    {
        ClassicAssert.False(string.IsNullOrEmpty(p2.Text));
        ClassicAssert.AreNotEqual(0, p2.Number);
    }
    ...
    {
        ClassicAssert.True(numbers.SequenceEqual(container.Items));
    }
    ...
    {
        ClassicAssert.AreEqual(parameter, p2.Parameter);
    }
    ...
    public void FreezeFirstParameterByParameterWithDifferentNameShouldNotAssignSameInstanceToSecondParameter(
        ...
        SingleParameterType<object> p2)
    {
        ClassicAssert.AreNotEqual(p1, p2.Parameter);
    }
    ...
    {
        ClassicAssert.AreEqual(property, p2.Property);
    }
    ...
    public void FreezeFirstParameterByPropertyWithDifferentNameShouldNotAssignSameInstanceToSecondParameter(
        ...
        PropertyHolder<object> p2)
    {
        ClassicAssert.AreNotEqual(p1, p2.Property);
    }
    ...
    {
        ClassicAssert.AreEqual(field, p2.Field);
    }
    ...
    public void FreezeFirstParameterByFieldWithDifferentNameShouldNotAssignSameInstanceToSecondParameter(
        ...
        FieldHolder<object> p2)
    {
        ClassicAssert.AreNotEqual(p1, p2.Field);
    }

...
/// <summary>
/// This attribute acts as a <see cref="NUnit.Framework.TestCaseSourceAttribute" /> but allow incomplete parameter values,
...
public class AutoTestCaseSourceAttribute : Attribute, ITestBuilder
{
    /// <summary>
    ...
    /// Ignored if the source member is not a method.
    /// </param>
    protected AutoTestCaseSourceAttribute(
        Func<IFixture> fixtureFactory, Type sourceType, string sourceName, params object[] parameters)
    {
    ...
    public IEnumerable<TestMethod> BuildFrom(IMethodInfo method, Test suite)
    {
        ...
        {
            var parameters = new AutoTestCaseParameters(FixtureFactory, values)
            {
                Category = Category
            };
